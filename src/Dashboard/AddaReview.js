    ...
    return (
        <div>
            ...
            <form onSubmit={handelReviewSubmit} className='grid grid-cols-1 justify-items-center gap-5 mt-10'>
                <input required name='img' type="url" placeholder="Image URL" class="input input-bordered w-full max-w-xs" />
                <input required name='name' type="text" placeholder="Name" class="input input-bordered w-full max-w-xs" />
                ...
                <label class="input-group justify-center">
                    ...
                    <input required value={rating} name='rating' type="number" placeholder="rating" class="input input-bordered w-[15rem] max-w-xs" />
                ...
                <textarea required name='description' type="text" placeholder="Type here" class="input input-bordered w-full max-w-xs" />
